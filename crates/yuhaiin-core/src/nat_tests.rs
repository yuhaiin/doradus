...
fn nat_stats_expose_full_cone_reuse_reverse_and_close_lifecycle() {
    ...
    assert!(rendered.contains("# TYPE yuhaiin_nat_active_bindings gauge"));
    assert!(rendered.contains("yuhaiin_nat_active_bindings 1\n"));
    assert!(rendered.contains("yuhaiin_nat_reverse_hits 1\n"));
