...
mod tests {
    ...
    fn publish_keeps_old_arc_usable_and_returns_it() {
        ...
        first.proxies.push(doradus_store::GoProxyRuntimeConfig {
            id: "first".to_owned(),
            name: "first".to_owned(),
            ...
            layers: Vec::new(),
            transport: doradus_store::GoProxyTransport::Direct,
        ...
        second.proxies.push(doradus_store::GoProxyRuntimeConfig {
            id: "second".to_owned(),
    ...
    fn rebuild_failure_does_not_replace_previous_snapshot() {
        ...
        futures_block_on(async {
            store
                .repository()
                .put_maxmind_metadata(&doradus_store::MaxMindMetadataRecord {
    ...
    fn conditional_publish_rejects_a_stale_reload_without_replacing_snapshot() {
        ...
        current.proxies.push(doradus_store::GoProxyRuntimeConfig {
            id: "current".to_owned(),
    ...
    fn load_with_revision_returns_a_consistent_pair_for_management_readers() {
        ...
        next.proxies.push(doradus_store::GoProxyRuntimeConfig {
