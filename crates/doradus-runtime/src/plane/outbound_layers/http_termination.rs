...
use doradus_core::proxy::{stream_local_addr, with_stream_local_addr};
use doradus_core::{BoxFuture, Endpoint, Error, ErrorKind, FlowContext, Network, Result};
use doradus_store::{GoProxyLayer, GoProxyRuntimeConfig};
use doradus_trie::DomainTrie;

use doradus_protocol::http_server::parse_authority_with_default;
