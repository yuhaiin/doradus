...
use base64::Engine;
use doradus_core::{BoxFuture, DomainName, Endpoint, Error, ErrorKind, Network, Result};
use doradus_types::{InboundBasicAuth, InboundHttpRequest, InboundStreamHandler};
    ...
    H: HttpForwardHandler<S> + ?Sized,
{
    ...
    loop {
        ...
        let http_host = doradus_core::sniff::http_host(request.headers.as_bytes());
