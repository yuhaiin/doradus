...
use doradus_api::service::{InjectedTun, RuntimeService, ServiceOptions};
use doradus_runtime::TunRuntimeConfig;
use jni::Env;
use jni::EnvUnowned;
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_io_github_asutorufa_doradus_rust_RustRuntime_nativeStart<'local>(
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_io_github_asutorufa_doradus_rust_RustRuntime_nativeStop(
    _env: EnvUnowned<'_>,
    _class: JClass<'_>,
    handle: jlong,
) {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_io_github_asutorufa_doradus_rust_RustRuntime_nativeApiPort(
    _env: EnvUnowned<'_>,
    _class: JClass<'_>,
    handle: jlong,
) -> jint {
