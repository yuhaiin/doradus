//! Stable contracts shared by the doradus crates.
//!
...
pub mod dns {
    pub use doradus_dns::dns::*;
}
pub mod dns_hosts {
    pub use doradus_dns::dns_hosts::*;
}
pub mod dns_resolver {
    pub use doradus_dns::dns_resolver::*;
}
pub mod dns_resolver_stack {
    pub use doradus_dns::dns_resolver_stack::*;
}
pub mod dns_tcp {
    pub use doradus_dns::dns_tcp::*;
}
pub mod flow;
pub mod geo;
