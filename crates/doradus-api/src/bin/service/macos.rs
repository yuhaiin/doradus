...
const PLIST_PATH: &str = "/Library/LaunchDaemons/com.asutorufa.doradus.plist";
const SERVICE: &str = "com.asutorufa.doradus";
...
mod tests {
    ...
    fn launchd_plist_contains_runtime_arguments_and_nfs_mode() {
        ...
        assert!(plist.contains("Application Support/doradus"));
    }
