...
pub struct NetworkSplitHttp2Proxy {
    pub(super) upstream: Arc<dyn AsyncProxy>,
    pub(super) connections: tokio::sync::Mutex<Vec<Arc<yuhaiin_chain::H2Connection>>>,
...
pub fn parse_node_tag(record: &yuhaiin_store::GoNodeTagRecord) -> Result<NodeTagDefinition> {
