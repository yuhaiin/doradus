...
pub(crate) struct HttpForwardConnection {
    ...
    flow: yuhaiin_core::flow::FlowKey,
...
impl yuhaiin_protocol::http_server::HttpForwardHandler<HttpInboundStream> for HttpInboundHandler {
    ...
    fn record_bytes(
        ...
        direction: yuhaiin_protocol::http_server::HttpTrafficDirection,
        bytes: usize,
    ) {
        let direction = match direction {
            yuhaiin_protocol::http_server::HttpTrafficDirection::Upload => TunFlowDirection::Upload,
            yuhaiin_protocol::http_server::HttpTrafficDirection::Download => {
