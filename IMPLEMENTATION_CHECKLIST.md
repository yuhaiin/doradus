...
| `make go-protocol-interop-smoke`（2026-08-12 当前轮） | Podman host network；真实 Go checkout/client/server | 8/8：Yuubinsya TCP/UOT/native UDP/Ping、WebSocket→H2、TLS→WebSocket→H2→Yuubinsya、H2 v1、VLESS、VLESS over TLS、VMess、Trojan |
