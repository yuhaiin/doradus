...
| `[x]` | HTTP/2 transport | 是 | 是 | `chain`, runtime HTTP2 inbound；新增真实进程 HTTP/2 inbound → route rule → fixed + HTTP CONNECT outbound，覆盖 H2 CONNECT、内层 HTTP framing、domain authority、connections/统计和 shutdown |
